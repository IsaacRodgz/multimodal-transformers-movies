...
MODELS = {
    ...
    "mmtrvpa": MMTransformerHierarchicalMoviescopeClf, # video-plot-audio (MMTransformerGMUVPAClf, MMTransformerConcatVPAClf, MMTransformerGMUNoEncodersClf)
