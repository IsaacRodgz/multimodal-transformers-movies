...
class ImageBertEmbeddings(nn.Module):
    """Construct the embeddings from image as in "Supervised Multimodal Bitransformers for Classifying Images and Text " [http://arxiv.org/abs/1909.02950]
    """
    
    def __init__(self, args, embeddings):
        super(ImageBertEmbeddings, self).__init__()
        self.args = args
        self.img_embeddings = nn.Linear(args.v_feature_size, args.v_hidden_size)
